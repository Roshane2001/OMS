            ...
            if ($default_courier_id == 11) {
                ...
                if ($courier_type == 1) {
                    ...
                    $courier_warning = "Koombiyo New Parcel API not yet implemented";
                            ...
                            $api_file_path = $_SERVER['DOCUMENT_ROOT'] . '/OMS_R/dist/api/koombiyo_delivery_api.php';
...
// FIXED TransExpress New Parcel API Integration Section
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/OMS_R/dist/api/transexpress_new_parcel_api.php');
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/OMS_R/dist/api/transexpress_existing_parcel_api.php');
    ...
    include($_SERVER['DOCUMENT_ROOT'] . '/OMS_R/dist/api/royal_express_existing_parcel_api.php');
